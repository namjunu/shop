...
<div id="login-box">
    ...
    <form action="/Login/addPoint" method="post" class="hidden">
    ...
    <form action="/Login/usePoint" method="post" class="hidden">
    	<input type="hidden" id="U_ID" name ="U_ID" value="<%= session.getAttribute("U_ID") %>">
...
<% } else { %>
    ...
    <br>
    <a href="/Login/createID" class="link-button">회원가입</a>
<% } %>
<br>
<br>
<a href="/Shop/cart" class="link-button">장바구니 보기</a>
<br>
<br>
<a href="/Shop/purchaseHistory" class="link-button">주문내역</a>
<br>
<br>
<a href="" class="link-button">홈으로</a>
</div>
</body>
</html>