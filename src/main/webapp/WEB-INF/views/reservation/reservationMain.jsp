...
<body>
	<script>
	    ...
	    <form action="/reservation/bookadd" method="post">
	        ...
	        <input type="text" id="add_R_hospital_name" name="R_hospital_name" value="<%= session.getAttribute("selectedHospital") %>" required><br>
	    ...
	    <form action="/reservation/bookmodify" method="post">
	        ...
	        <input type="text" id="edit_R_hospital_name" name="R_hospital_name" value="<% session.getAttribute("selectedHospital"); %>" required><br>
